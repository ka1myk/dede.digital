...
?>
	...
	<div class="post-wrap grid-item" style="background-color:<?=$color?>">
	<a class="post-link " href="<?=the_permalink();?>">
    
     	
            <div class="anons-img-wrap" style=" height:<?=$height?>px"><div class="anons-img anim" style="background-image:url(<?=$anons_img['url'];?>)"></div></div>
