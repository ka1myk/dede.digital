...
<section>
	<div class="wrapper">
        ...
        <?php get_template_part('filter');  ?>
            ...
            <?
				/*
				/*Черновик для фильтрации записей по свойству доп поля
				$args = array(
					'meta_query' => array(
						array(
							'key'     => 'temp',
				...
				//query_posts( array ( 'orderby' => 'id', 'order' => 'ASC' ) ); 
				?>
                ...
                <?php //echo do_shortcode('[ajax_load_more container_type="div" post_type="post" posts_per_page="1" max_pages="1" images_loaded="true"]'); ?>
...
<? /* <button onClick="pckry.reloadItems()" value="dsdfvsfv">sdfvsfdv</button> */?>
