...
<head>
    ...
    <script src="/wp-content/themes/mynomadtales/sticky-kit/sticky-kit.js"> </script>
...
<body>
	...
	<header>
    	...
    	<div class="header">
            ...
            <div class="mobile-menu-button stick" id="stick"><a href="/" onclick="content_overheight(this); return false;" content="header-menu social-links"><span></span></a></div>
            
            <script> $(".stick").stick_in_parent();</script>
            
           
            <div class="header-menu-wrap" id="header-menu">
            <?php
				wp_nav_menu([
					'container' => 'div',
